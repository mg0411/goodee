...
function rpcInputButtonClick(){
    ...
    resultString = "유저:"+userRpc; // * 주의 * 다시 게임을 할 경우 이 명령줄로 인해 기존 내용이 초기화가 됨. 대입 연산자 때문에 변수 resultstring 이 초기화 됨
    ...
    switch(userRpc){
        case "가위":
            divRpcImgUser.innerHTML = "<img src='c_sc.png'>"
            break;
        case "바위":
            divRpcImgUser.innerHTML = "<img src='c_ro.png'>"
            break;
        case "보":
            divRpcImgUser.innerHTML = "<img src='c_pa.png'>"
            break;
    }
    switch(comRpc){
        case "가위":
